...
function flash_scripts() {
	...
	wp_enqueue_style( 'responsive', get_template_directory_uri() . '/css/responsive'.$suffix.'.css' , array(), false, false);
        ...
        //Custom CSS
        wp_enqueue_style('custom-css', get_template_directory_uri() . '/css/custom-style.css', array(), false, false);
...
function custom_script() {
    ...
    wp_register_script('custom-scripts', get_template_directory_uri() . '/js/custom-scripts.js', array('jquery'), '', false);
